...
def seed_data():
    with app.app_context():
        ...
        employer_users = [
            create_user("ООО Пример", "employer@example.com", "employer", "employer123"),
            create_user("Северный Вектор", "north@example.com", "employer", "north123"),
            create_user("HR Bridge", "bridge@example.com", "employer", "bridge123"),
        ]
        applicant_users = [
